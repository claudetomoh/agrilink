    ...
    <a href="<?= APP_URL ?>/buyer/product?id=<?= $rec['id'] ?>"
      ...
      <div class="flex items-center gap-3 mb-3">
        <div class="w-11 h-11 rounded-xl bg-white/20 flex items-center justify-center flex-shrink-0">
          ...
          <img src="<?= APP_URL . e($rec['image']) ?>" alt="<?= e($rec['name']) ?>"
               style="width:100%;height:100%;object-fit:cover;border-radius:.6rem">
          <?php else: ?>
          <span class="material-symbols-outlined text-white" style="font-size:1.4rem">yard</span>
          <?php endif; ?>
        </div>
...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
  ...
  <div class="lg:col-span-3">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
      ...
      <div class="bg-surface-container-lowest rounded-[1.5rem] overflow-hidden border border-outline-variant/10 shadow-sm hover:shadow-md transition-shadow flex flex-col">
        <!-- Image / placeholder -->
        <div class="h-40 bg-surface-container flex items-center justify-center relative overflow-hidden">
          <?php if (!empty($item['image'])): ?>
          <img src="<?= APP_URL . e($item['image']) ?>" alt="<?= e($item['name']) ?>"
               style="width:100%;height:100%;object-fit:cover">
          <?php else: ?>
          <span class="material-symbols-outlined text-primary" style="font-size:3.5rem">yard</span>
          <?php endif; ?>
        ...
        <div class="p-5 flex flex-col flex-1">
          ...
          <div class="flex items-center justify-between mt-2 mb-4">
            ...
            <span class="text-sm font-semibold text-on-surface-variant"><?= e($item['quantity']) ?> <?= e($item['unit']) ?>s left</span>
          </div>
